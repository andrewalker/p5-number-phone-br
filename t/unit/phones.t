...
ok(!defined $class->new('+1 (714) 781-3463'), 'valid US phone number is not valid BR phone number');
ok(!defined $class->new('(112) 345-6789'), 'valid phone number with misplaced () is not valid');
ok(!defined $class->new('0xx11 2345-6789'), 'letters are not valid');
